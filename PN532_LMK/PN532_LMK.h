...
#ifndef __PN532_LMK_H__
#define __PN532_LMK_H__

#include <stdint.h>
#include "PN532Interface_LMK.h"

// PN532_LMK Commands
#define PN532_LMK_COMMAND_DIAGNOSE              (0x00)
#define PN532_LMK_COMMAND_GETFIRMWAREVERSION    (0x02)
#define PN532_LMK_COMMAND_GETGENERALSTATUS      (0x04)
#define PN532_LMK_COMMAND_READREGISTER          (0x06)
#define PN532_LMK_COMMAND_WRITEREGISTER         (0x08)
#define PN532_LMK_COMMAND_READGPIO              (0x0C)
#define PN532_LMK_COMMAND_WRITEGPIO             (0x0E)
#define PN532_LMK_COMMAND_SETSERIALBAUDRATE     (0x10)
#define PN532_LMK_COMMAND_SETPARAMETERS         (0x12)
#define PN532_LMK_COMMAND_SAMCONFIGURATION      (0x14)
#define PN532_LMK_COMMAND_POWERDOWN             (0x16)
#define PN532_LMK_COMMAND_RFCONFIGURATION       (0x32)
#define PN532_LMK_COMMAND_RFREGULATIONTEST      (0x58)
#define PN532_LMK_COMMAND_INJUMPFORDEP          (0x56)
#define PN532_LMK_COMMAND_INJUMPFORPSL          (0x46)
#define PN532_LMK_COMMAND_INLISTPASSIVETARGET   (0x4A)
#define PN532_LMK_COMMAND_INATR                 (0x50)
#define PN532_LMK_COMMAND_INPSL                 (0x4E)
#define PN532_LMK_COMMAND_INDATAEXCHANGE        (0x40)
#define PN532_LMK_COMMAND_INCOMMUNICATETHRU     (0x42)
#define PN532_LMK_COMMAND_INDESELECT            (0x44)
#define PN532_LMK_COMMAND_INRELEASE             (0x52)
#define PN532_LMK_COMMAND_INSELECT              (0x54)
#define PN532_LMK_COMMAND_INAUTOPOLL            (0x60)
#define PN532_LMK_COMMAND_TGINITASTARGET        (0x8C)
#define PN532_LMK_COMMAND_TGSETGENERALBYTES     (0x92)
#define PN532_LMK_COMMAND_TGGETDATA             (0x86)
#define PN532_LMK_COMMAND_TGSETDATA             (0x8E)
#define PN532_LMK_COMMAND_TGSETMETADATA         (0x94)
#define PN532_LMK_COMMAND_TGGETINITIATORCOMMAND (0x88)
#define PN532_LMK_COMMAND_TGRESPONSETOINITIATOR (0x90)
#define PN532_LMK_COMMAND_TGGETTARGETSTATUS     (0x8A)

#define PN532_LMK_RESPONSE_INDATAEXCHANGE       (0x41)
#define PN532_LMK_RESPONSE_INLISTPASSIVETARGET  (0x4B)
...
#define PN532_LMK_GPIO_VALIDATIONBIT            (0x80)
#define PN532_LMK_GPIO_P30                      (0)
#define PN532_LMK_GPIO_P31                      (1)
#define PN532_LMK_GPIO_P32                      (2)
#define PN532_LMK_GPIO_P33                      (3)
#define PN532_LMK_GPIO_P34                      (4)
#define PN532_LMK_GPIO_P35                      (5)
...
{
public:
    PN532_LMK(PN532Interface_LMK &interface);

    void begin(void);

    // Generic PN532_LMK functions
    bool SAMConfig(void);
    ...
    /**
    * @brief    Init PN532_LMK as a target
    ...
    */
    ...
    bool readPassiveTargetID(uint8_t cardbaudrate, uint8_t *uid, uint8_t *uidLength, uint16_t timeout = 100); // Valeur par défaut 1000
