...
class EmulateTag_LMK{

public:
EmulateTag_LMK(PN532Interface_LMK &interface) : pn532(interface), uidPtr(0), tagWrittenByInitiator(false), tagWriteable(true), updateNdefCallback(0) { }
